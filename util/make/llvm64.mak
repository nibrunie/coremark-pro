...
# This flag contains the only difference from clang for 32b platform, defining size of long and pointer types.
...
# LINKER SECTION
# -lm is optional. Some linkers (linux clang) do not include math library by default.
LINKER_FLAGS	+=  
